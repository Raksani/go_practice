...
func newsAggHandler(w http.ResponseWriter, r *http.Request){
	...
	*/
	...
	//create a map
	news_map := make(map[string]NewsMap2)
	...
	for _, Location := range s.Locations {
		...
		for i, _ := range n.Keywords {
			news_map[n.Titles[i]] = NewsMap2{n.Keywords[i], n.Locations[i]} 
		}
	}
	...
	p := NewsAggPage{Title: "Amazing News Aggregator", News2: news_map}
